  ...
  results.map(result => {
      ...
      <div class="card">
          <div class="card-body">
              ...
              <h6 class=' text-center my-2 text-truncate'><b>${result.recipe.label}</b></h6>
              <div class="d-flex justify-content-between align-items-center">
                  <h6 class=' align-self-stretch mx-auto my-auto'><span><b>Calories: </b></span> ${result.recipe.calories.toFixed(2)}</h6>
